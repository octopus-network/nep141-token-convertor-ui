...
export class ConvertorContract {
  ...
  public static get_storage_fee_gap_of(
    account_id: AccountId,
  ): Promise<TRANSFER_AMOUNT> {
    return wallet
      .account()
      .viewFunction(ConvertorContract.contract_id, 'get_storage_fee_gap_of', {
        account_id: account_id,
      });
  }

  public static storage_deposit(
    account_id: AccountId | null,
    registration_only: boolean | null,
    deposit_near: API_AMOUNT,
  ): NearChangeMethod {
  ...
  public static get_pools(
    from_index: number,
    limit: number,
  ): Promise<ConversionPool[]> {
    return wallet
      .account()
      .viewFunction(ConvertorContract.contract_id, 'get_pools', {
  ...
  public static create_pool(
    ...
    console.log(
      '0.125near',
      NearAmount.FT_STORAGE_FOR_REGISTER_AMOUNT.toString(),
    );
  ...
  public static async deposit_token_into_pool(
    ...
    return new NearChangeMethod(
      ...
      'ft_transfer_call',
      {
        ...
        amount: NearAmount.readable_to_transfer(
          token_amount,
  ...
  public static async convert(
    ...
    let in_token_transfer_amount = NearAmount.readable_to_transfer(
      in_token_amount,
      in_token_decimals,
    );
  ...
  public static withdraw_token_in_pool(
    pool_id: number,
    token_id: AccountId,
  ): NearChangeMethod {
    return new NearChangeMethod(this.contract_id, 'withdraw_token_in_pool', {
      pool_id: pool_id,
      token_id: token_id,
    });
  }

  public static delete_pool(pool_id: number): NearChangeMethod {
    return new NearChangeMethod(this.contract_id, 'delete_pool', {
      pool_id: pool_id,
    });
  }
}
